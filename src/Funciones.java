...
public class Funciones {
	 ...
	 * @param arreglo Datos en los que se buscará el valor
	 * @param valor Dato a encontrar
	 ...
	 * @param arreglo Datos en los que se buscará el valor
	 * @param valor Dato a encontrar
	 * @param p primera posición
	 * @param u última posición
	 * @return Posición del valor en el arreglo o -1 si no lo encuentra
	 */
	...
	/**
	 * Compara dos listas ligadas y devuelve los valores que son compartidos entre estas dos
	 * @param cabeza1 Nodo que apunta a la cabeza de la primera lista
	 * @param cabeza2 Nodo que apunta a la cabeza de la segunda lista
	 ...
	 * @param x Radicando
	 * @param precision Indica que el resultado puede estar +/- la precisión 
	...
	/**
	 * Encuentra los valores repetidos de dos listas ligadas y los guarda en una tercera
	 * Este método usa un HashSet como ayuda
	 * @param cabeza1 Nodo que apunta al primer elemento de una de las listas
